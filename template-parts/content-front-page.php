...
if( is_singular() ) {
	...
	the_date( get_option( 'date_format' ), '<div class="authorial-post-date">', '</div> <!-- .post-date -->' . PHP_EOL );
	the_content();
} else {
	the_date( get_option( 'date_format' ), '<div class="authorial-post-date"><span></span>', '</div> <!-- .post-date -->' . PHP_EOL );
