...
function authorial_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Left Footer Widgets', 'authorial' ),
		'id'            => 'footer-widgets-left',
		'description'   => esc_html__( 'Left-hand widget area', 'authorial' ),
	...
	register_sidebar( array(
		'name'          => esc_html__( 'Right Footer Widgets', 'authorial' ),
		'id'            => 'footer-widgets-right',
		'description'   => esc_html__( 'Right-hand widget area', 'authorial' ),
		'before_widget' => '<aside id="%1$s" class="widget %2$s">',
		'after_widget'  => '</aside>',
		'before_title'  => '<h1 class="widget-title">',
		'after_title'   => '</h1>',
...
function authorial_scripts() {
  ...
  wp_enqueue_style( 'google-fonts', '//fonts.googleapis.com/css?family=Roboto|Libre+Baskerville' );
	...
	if( is_front_page() ) {
		wp_enqueue_style( 'authorial-front-page', get_stylesheet_directory_uri() . '/front-page-style.css' );
	}
